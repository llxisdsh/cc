...
type ccOFHTMapAdapter struct {
	m *cc.OFHTMap[int, int]
}

func (a *ccOFHTMapAdapter) Store(k, v int)         { a.m.Store(k, v) }
func (a *ccOFHTMapAdapter) Load(k int) (int, bool) { return a.m.Load(k) }

type ccDWHTMapAdapter struct {
	m *cc.DWHTMap[int, int]
}

func (a *ccDWHTMapAdapter) Store(k, v int)         { a.m.Store(k, v) }
func (a *ccDWHTMapAdapter) Load(k int) (int, bool) { return a.m.Load(k) }
...
func TestLatencySummary(t *testing.T) {
	...
	impls := []struct {
		...
		{"cc.OFHTMap", func() MapInterface { return &ccOFHTMapAdapter{cc.NewOFHTMap[int, int]()} }},
		{"cc.DWHTMap", func() MapInterface { return &ccDWHTMapAdapter{cc.NewDWHTMap[int, int]()} }},
	}
