...
func TestInsert_cc_DWHTMap(t *testing.T) {
	t.Run("1 no_pre_size", func(t *testing.T) {
		testInsert_cc_DWHTMap(t, total, 1, false, true, true)
	})
	t.Run("64 no_pre_size", func(t *testing.T) {
		testInsert_cc_DWHTMap(t, total, runtime.GOMAXPROCS(0), false, true, false)
	})
	t.Run("1 pre_size", func(t *testing.T) {
		testInsert_cc_DWHTMap(t, total, 1, true, false, false)
	})
	t.Run("64 pre_size", func(t *testing.T) {
		testInsert_cc_DWHTMap(t, total, runtime.GOMAXPROCS(0), true, false, false)
	})
}

func testInsert_cc_DWHTMap(
	t *testing.T,
	total int,
	numCPU int,
	preSize bool,
	...
	var m *cc.DWHTMap[int, int]
	if preSize {
		m = cc.NewDWHTMap[int, int](cc.WithCapacity(total))
	} else {
...
func TestInsert_cc_FunnelMap(t *testing.T) {
	t.Run("1 no_pre_size", func(t *testing.T) {
		testInsert_cc_FunnelMap(t, total, 1, false, true, true)
	})
	t.Run("64 no_pre_size", func(t *testing.T) {
		testInsert_cc_FunnelMap(t, total, runtime.GOMAXPROCS(0), false, true, false)
	})
	t.Run("1 pre_size", func(t *testing.T) {
		testInsert_cc_FunnelMap(t, total, 1, true, false, false)
	})
	t.Run("64 pre_size", func(t *testing.T) {
		testInsert_cc_FunnelMap(t, total, runtime.GOMAXPROCS(0), true, false, false)
	})
}

func testInsert_cc_FunnelMap(
	t *testing.T,
	total int,
	numCPU int,
	preSize bool,
	...
	var m *cc.FunnelMap[int, int]
	if preSize {
		m = cc.NewFunnelMap[int, int](cc.WithCapacity(total))
	} else {
...
func testInsert_cc_FlatMap(
	...
	var m *cc.FlatMap[int, int]
	if preSize {
		m = cc.NewFlatMap[int, int](cc.WithCapacity(total))
	} else {
...
func testInsertString_cc_FlatMap(
	...
	var m *cc.FlatMap[string, int]
	if preSize {
		m = cc.NewFlatMap[string, int](cc.WithCapacity(total))
	} else {
...
func testInsertString_cc_Map(
	...
	if preSize {
		m = cc.NewMap[String, int](cc.WithCapacity(total))
	} else {
