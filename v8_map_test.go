...
func TestV8MapZeroValue(t *testing.T) {
	var m V8Map[string, int]
...
func TestV8MapPointerKeyValueEscapes(t *testing.T) {
	var keyMap V8Map[*int, int]
	for i := range 10 {
		key := i
		keyMap.Store(&key, i)
	}
...
func TestV8MapBasicOperations(t *testing.T) {
	m := NewV8Map[string, int](WithCapacity(8))
...
func TestV8MapStringSemantics(t *testing.T) {
	var m V8Map[string, int]
...
func TestV8MapBuiltInHasherKeepsFloatSemantics(t *testing.T) {
	var m V8Map[float64, int]
...
func TestV8MapIntHashPartsAvoidsPowerOfTwoStrideClustering(t *testing.T) {
	const buckets = uintptr(1024)
	counts := make([]int, buckets)
	for i := uintptr(0); i < buckets*v8SlotsPerBucket; i++ {
		_, start := v8HashParts(i*v8SlotsPerBucket*buckets, true, buckets-1)
		counts[start]++
	}
	nonEmpty := 0
	maxBucket := 0
...
func TestV8MapNoOpWritesDoNotPublish(t *testing.T) {
	var m V8Map[int, int]
	const key = 42
...
func TestV8MapLoadAndUpdateDoesNotInsert(t *testing.T) {
	var m V8Map[int, int]
...
func TestV8MapComputeInsertDelete(t *testing.T) {
	m := NewV8Map[string, int]()
...
func TestV8MapDeleteCompactsOnResize(t *testing.T) {
	m := NewV8Map[int, int](WithCapacity(64))
	for i := range 64 {
		m.Store(i, i)
	}
	for i := range 48 {
...
func TestV8MapSameKeyTombstoneReuse(t *testing.T) {
...
func TestV8MapStoreReusesHashAfterResizeHelp(t *testing.T) {
...
func TestV8MapRangeSnapshotDoesNotRepeatBucketAfterMutation(t *testing.T) {
	m := NewV8Map[int, int](
		WithCapacity(8),
		WithKeyHasher(func(int, uintptr) uintptr { return 0 }),
	)
...
func TestV8MapConcurrentInsertLoad(t *testing.T) {
	const n = 4096
	m := NewV8Map[int, int](WithCapacity(n))
...
func TestV8MapConcurrentResize(t *testing.T) {
	const n = 8192
	m := NewV8Map[int, int](WithCapacity(1))
...
func TestV8MapStringResize(t *testing.T) {
	const n = 3000
	m := NewV8Map[string, int]()
	for i := range n {
...
func TestV8MapBucketAndEntryLayout(t *testing.T) {
	size := unsafe.Sizeof(v8Bucket{})
	if size != 16 {
	...
	align := unsafe.Alignof(v8Entry[int, int]{})
